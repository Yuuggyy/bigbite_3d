    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            }}>{parametres?.nom_restaurant || 'Big Bite'}</h1>
            {!isMobile && (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          ...
          <button onClick={() => setShowPanier(true)} style={{
            ...
            whiteSpace: 'nowrap',
            boxShadow: totalItems > 0 ? `0 4px 16px rgba(255,107,26,0.35)` : 'none',
          }}>
            🛒 {!isMobile && L.panier}
            {totalItems > 0 && (
              <span style={{
      ...
      {showAppel && (
        <div style={{
          ...
          background: 'rgba(184,58,0,0.50)', backdropFilter: 'blur(4px)',
          ...
          <div style={{
            ...
            boxShadow: '0 20px 60px rgba(184,58,0,0.25)',
      ...
      {toast && (
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(184,58,0,0.25)',
